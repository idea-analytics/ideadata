...
Since you already got them ready you can type them in in turn and hit return. If you want to see what exactly has happened you can use the `{usethis}` packages `edit_r_environ()` function, which will open up your `.Renviron` file right in your RStudio source pane. 

## Where do I find this SQL driver description?
...
That's it. No quotes. No braces. You can even simply copy and paste into the console pane (i.e., the REPL) in RStudio. 
