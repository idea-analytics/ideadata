...
#' Connect to `PersistenceHistorical` table in `Persistence` database on `REDACTED-SQLSERVER`
#'
...
#' Connect to `PersistenceCode` table in `Persistence` database on `REDACTED-SQLSERVER`
#'
#'
#' @return a `tbl_sql SQL Server` object.
#' @export
...
#' Connect to `PersitenceCodeHistorical` (*sic*) table in `Persistence` database on `REDACTED-SQLSERVER`
#'
#'
#' @return a `tbl_sql SQL Server` object.
#' @export
...
#' Connect to `PersistenceReasonsCodes`  table in `Persistence` database on `REDACTED-SQLSERVER`
#'
#'
#' @return a `tbl_sql SQL Server` object.
#' @export
